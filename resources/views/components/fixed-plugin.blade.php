    ...
    <div class="card shadow-lg">
        <div class="card-header pb-0 pt-3 ">
            <div class="float-start">
                <h5 class="mt-3 mb-0">UAEMéx Zumpango.</h5>
                <p>MENU</p>
            </div>
        ...
        <div class="card-body pt-sm-3 pt-0 overflow-auto">
            ...
            <div>
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link {{ Route::currentRouteName() == 'home' ? 'btn btn-sm btn-warning' : '' }}"
                            href="{{ route('home') }}">
                            <span class="nav-link-text ms-1">Inicio</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('aulas.*') ? 'btn btn-sm btn-warning' : '' }}"
                            href="{{ route('aulas.index') }}">
                            <span class="nav-link-text ms-1">Aulas</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('carreras.*') ? 'btn btn-sm btn-warning' : '' }}"
                            href="{{ route('carreras.index') }}">
                            <span class="nav-link-text ms-1">Carreras</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('semestres.*') ? 'btn btn-sm btn-warning' : '' }}"
                            href="{{ route('semestres.index') }}">
                            <span class="nav-link-text ms-1">Semestres</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('maestros.*') ? 'btn btn-sm btn-warning' : '' }}"
                            href="{{ route('maestros.index') }}">
                            <span class="nav-link-text ms-1">Maestros</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('periodos.*') ? 'btn btn-sm btn-warning' : '' }}"
                            href="{{ route('periodos.index') }}">
                            <span class="nav-link-text ms-1">Periodos Academicos</span>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Route::is('materias.*') ? 'btn btn-sm btn-warning' : '' }}"
