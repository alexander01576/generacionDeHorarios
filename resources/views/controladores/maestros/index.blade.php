...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Maestros'])
                                    ...
                                    <div class="card-header pb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 d-flex justify-content-end">
                                                <a href="{{ route('maestros.create') }}" class="btn btn-success"
                                            ...
                                            <tbody>
                                                @foreach ($Maestros as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                action="{{ route('maestros.destroy', $item->id) }}"
                                                                method="POST" class="frmEliminar">
                                                                @csrf
                                                                @method('DELETE')
                                                                <a href="{{ route('maestros.edit', $item) }}"
