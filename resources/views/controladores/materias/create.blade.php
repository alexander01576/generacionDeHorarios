...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Creacion de Materia'])
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="nombre" id="nombre"
                                                        placeholder="Nombre materia" class="form-control" required>
                                                </div>
                                                <div class="col-md-4">
...
@push('js')
    <script>
        $('form').on('submit', function(e) {
            ...
            submit_with_ajax("{{ route('materias.store') }}", 'POST', parameters,
                function(data) {
                    Swal.fire({
                        title: 'Alerta',
                        text: data.message,
