...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Semestres'])
                                    ...
                                    <div class="card-header pb-2">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 d-flex justify-content-end">
                                                <a href="{{ route('semestres.create') }}" class="btn btn-success"
                                            ...
                                            <tbody>
                                                @foreach ($semestres as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form
                                                                action="{{ route('semestres.destroy', $item->id) }}"
                                                                method="POST" class="frmEliminar">
                                                                @csrf
                                                                @method('DELETE')
                                                                <a href="{{ route('semestres.edit', $item) }}"
