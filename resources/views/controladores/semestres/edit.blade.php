...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Edición semestre'])
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" name="nombre" id="nombre"
                                                        placeholder="Nombre semestre" class="form-control"
                                                        value="{{ $semestre->nombre }}" required>
                                                </div>
...
@push('js')
    <script>
        $('form').on('submit', function(e) {
            ...
            submit_with_ajax("{{ route('semestres.update', $semestre->id) }}", 'POST', parameters,
                function(data) {
                    Swal.fire({
                        title: 'Alerta',
                        text: data.message,
